...
typedef struct {
  ...
  real_T Switch_i;
  real_T FilterCoefficient_d;
  real_T Sum_n;
  real_T ZeroGain_n;
  real_T DeadZone_i;
  real_T IntegralGain_c;
  real_T Switch_g;
  real_T a_a;
  real_T FilterCoefficient_py;
  real_T Sum_d;
  real_T ZeroGain_o;
  real_T DeadZone_g;
...
typedef struct {
  ...
  real_T Filter_CSTATE_m;
  real_T Integrator_CSTATE_i;
  real_T Filter_CSTATE_oe;
  real_T Integrator_CSTATE_m;
  real_T Filter_CSTATE_e;
} X_machine_tool_T;
...
typedef struct {
  ...
  boolean_T Filter_CSTATE_m;
  boolean_T Integrator_CSTATE_i;
  boolean_T Filter_CSTATE_oe;
  boolean_T Integrator_CSTATE_m;
  boolean_T Filter_CSTATE_e;
} XDis_machine_tool_T;
...
typedef struct {
  ...
  real_T Integrator_Reset_ZC_e;
  real_T Filter_Reset_ZC_b;
  real_T DeadZone_LwrReg_ZC_g;
  real_T DeadZone_UprReg_ZC_o;
  real_T NotEqual_RelopInput_ZC_p;
  real_T SignPreSat_Input_ZC_l;
  real_T SignPreIntegrator_Input_ZC_e;
  real_T Saturation_UprLim_ZC_i;
  real_T Saturation_LwrLim_ZC_p;
  real_T Integrator_Reset_ZC_n;
  real_T Filter_Reset_ZC_p;
  real_T DeadZone_LwrReg_ZC_h;
  real_T DeadZone_UprReg_ZC_m;
  real_T NotEqual_RelopInput_ZC_px;
  ...
  real_T Integrator_Reset_ZC_a;
  real_T Filter_Reset_ZC_a;
  real_T DeadZone_LwrReg_ZC_gk;
  real_T DeadZone_UprReg_ZC_j;
  real_T NotEqual_RelopInput_ZC_c;
  real_T SignPreSat_Input_ZC_o;
  real_T SignPreIntegrator_Input_ZC_h;
  real_T Saturation_UprLim_ZC_e;
  real_T Saturation_LwrLim_ZC_l;
  ...
  real_T Integrator_Reset_ZC_o;
  real_T Filter_Reset_ZC_h;
  real_T DeadZone_LwrReg_ZC_i;
  real_T DeadZone_UprReg_ZC_i;
  real_T NotEqual_RelopInput_ZC_f;
  real_T SignPreSat_Input_ZC_e;
  real_T SignPreIntegrator_Input_ZC_f;
  real_T Saturation_UprLim_ZC_id;
  real_T Saturation_LwrLim_ZC_h;
} ZCV_machine_tool_T;
...
typedef struct {
  ...
  ZCSigState Integrator_Reset_ZCE_g;
  ZCSigState Filter_Reset_ZCE_m;
  ZCSigState Integrator_Reset_ZCE_h;
  ZCSigState Filter_Reset_ZCE_l;
  ZCSigState Integrator_Reset_ZCE_gd;
  ZCSigState Filter_Reset_ZCE_c;
  ZCSigState Integrator_Reset_ZCE_ic;
  ZCSigState Filter_Reset_ZCE_j;
  ZCSigState Integrator_Reset_ZCE_k;
  ZCSigState Filter_Reset_ZCE_g;
...
struct P_machine_tool_T_ {
  ...
  real_T PIDController1_InitialConditionForFilter_l;
  ...
  real_T PIDController1_InitialConditionForIntegrator_h;
  real_T PIDController_InitialConditionForIntegrator_h;
  real_T PIDController1_InitialConditionForIntegrator_m;
  real_T Xaxis_v0;
  real_T Yaxis_v0;
  real_T Zaxis_v0;
